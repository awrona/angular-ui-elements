...
const ngModuleName = 'cre8.core.services.ripple';

module.exports = ngModuleName;

angular.module(ngModuleName, [])
  .factory('$cre8InkRipple', InkRippleService)
  .directive('$cre8InkRipple', InkRippleDirective)
  .directive('$cre8NoInk', attrNoDirective())
  .directive('cre8NoBar', attrNoDirective())
  .directive('cre8NoStretch', attrNoDirective());

function InkRippleDirective($cre8InkRipple) {
  return {
    controller: angular.noop,
    link: function (scope, element, attr) {
      if (attr.hasOwnProperty('$cre8InkRippleCheckbox')) {
        $cre8InkRipple.attachCheckboxBehavior(scope, element);
      } else {
        $cre8InkRipple.attachButtonBehavior(scope, element);
      }
    }
  };
}
...
function InkRippleService($window, $timeout) {
  ...
  function attach(scope, element, options) {
    if (element.controller('$cre8NoInk')) return angular.noop;
    ...
    var rippleSize,
        controller = element.controller('$cre8InkRipple') || {},
        counter = 0,
        ripples = [],
        states = [],
